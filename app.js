...
var UIController = (function(){
    ...
    return {
        ...
        clearFields: function(){
            ...
            fieldsArr.forEach(function(curVal, index, array){
                curVal.value = "";
            });
            
            fieldsArr[0].focus();
        },
        // Insert budget into DOM
...
//            document.querySelector(DOMstrings.itemPercentageLabel).textContent = obj.percentage;
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function(){
        ...
        var percetages = budgetCtrl.getPercentages();
        
        // Update the UI with the new percentages
        UICtrl.displayPercentages(percetages);
